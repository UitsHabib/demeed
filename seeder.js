...
async function init() {
  ...
  function permissionSeeder(callback) {
    User.findOne({
      ...
      const permissions = [
        {
          title: "System Admin Permission",
          description: "This is the default permission for System Admin",
          type: "standard",
          created_by: admin.id,
          updated_by: admin.id,
        },
  ...
  function profilePermissionSeeder(callback) {
    User.findOne({
      ...
      Promise.all([Profile.findOne({ where: { title: "System Admin" } }), Permission.findOne({ where: { title: "System Admin Permission" } })]).then(
        function (values) {
